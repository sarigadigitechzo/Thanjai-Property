export const BLOG_POSTS = [
  {
    ...
    content: `
      <p class="blog-lead">Purchasing real estate in Tamil Nadu is one of the safest multi-generational investments when backed by verified legal Patta titles and DTCP/RERA approvals. Here is what every buyer must check before committing.</p>
  ...
  },
  {
    ...
    content: `
      <p class="blog-lead">Agricultural farmlands along the Kaveri river basin in Kumbakonam and Thanjavur continue to attract high-net-worth investors seeking passive yield, organic farming retreats, and long-term land value appreciation.</p>
  ...
  },
  {
    ...
    content: `
      <p class="blog-lead">Traditional South Indian courtyard architecture (Thinnai & Mutram) is experiencing a revival in high-end villa designs across Chennai, Trichy, and Thanjavur.</p>
  ...
  },
  {
    ...
    content: `
      <p class="blog-lead">Central Tamil Nadu cities like Trichy and Thanjavur are benefiting from infrastructure expansions including airport upgrades and NH highway widening, fueling 12-15% annual commercial property appreciation.</p>

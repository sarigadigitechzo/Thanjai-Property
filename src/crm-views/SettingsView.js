  ...
  const templates = [
    {
      ...
      name: 'Initial contact intro (Single Property Showcase)',
      tag: 'initial_contact_intro',
      category: 'Stage: Initial Contact',
      params: ['{{1}} Client Name', '{{2}} Property Title', '{{3}} Location', '{{4}} Price'],
    ...
    {
      id: 'welcome_message',
      name: 'Welcome message (Intro)',
      tag: 'welcome_message',
      category: 'Stage: New Lead (Auto)',
      params: ['{{1}} Client Name'],
    ...
    {
      id: 'property_follow_up',
      name: 'Property follow-up check-in',
      tag: 'property_follow_up',
      category: 'Stage: Follow Up Pending',
      params: ['{{1}} Client Name', '{{2}} Property Title', '{{3}} Location'],
      content: `Hello {{1}} 👋\n\nJust checking in about {{2}} in {{3}}.\n\nThe owner is open to reasonable price discussions for genuine buyers.\n\nWould you like to sit together and finalize the deal?\n\nWarm regards,\nThanjai Property Team`,
      isActive: true
    },
    {
      id: 'site_visit_confirmation',
      name: 'Site visit confirmation',
      tag: 'site_visit_confirmation',
      category: 'Stage: Site Visit Scheduled',
      params: ['{{1}} Client Name', '{{2}} Property Title', '{{3}} Date & Time', '{{4}} Location', '{{5}} Google Maps Link'],
    ...
    },
    {
      ...
      name: 'Site visit reminder (Today)',
      tag: 'site_visit_reminder',
      category: 'Stage: Site Visit (Reminder)',
      params: ['{{1}} Client Name', '{{2}} Property Title', '{{3}} Time', '{{4}} Meeting Point'],
      content: `Vanakkam {{1}} 🙏\n\nQuick reminder about your property visit today:\n🏠 Property: {{2}}\n⏰ Time: {{3}} Today\n📍 Meeting Point: {{4}}\n\nOur team is on the way. If you need directions, feel free to call us!\n\nBest regards,\nThanjai Property Team`,
      isActive: true
    },
    {
      id: 'site_visit_feedback',
      name: 'Site visit feedback request',
      tag: 'site_visit_feedback',
      category: 'Stage: Site Visit Completed',
      params: ['{{1}} Client Name', '{{2}} Property Title'],
      content: `Hello {{1}} 😊\n\nThank you for visiting {{2}} with us today!\n\nHow did you feel about the property and location?\n\nTo choose and finalise the property, feel free to call us or reply with text.\n\nWarm regards,\nThanjai Property Team`,
      isActive: true
    },
    {
      id: 'negotiation_check_in',
      name: 'Negotiation check-in',
      tag: 'negotiation_check_in',
      category: 'Stage: Negotiation',
      params: ['{{1}} Client Name', '{{2}} Property Title', '{{3}} Proposed Meeting Date / Time'],
      content: `Hello {{1}} 🤝\n\nGood news! The owner of {{2}} responded positively to your offer.\n\nCan we meet at our office on {{3}} to finalize the agreement?\n📍 Location: Thanjai Property Office, Siva Sakthi Apartment, Near New Bus Stand, Thanjavur.\n\nBest regards,\nThanjai Property Team`,
      isActive: true
    },
    {
      id: 'bank_loan_assistance',
      name: 'Bank loan assistance',
      tag: 'bank_loan_assistance',
      category: 'Stage: Bank Loan',
      params: ['{{1}} Client Name', '{{2}} Property Title'],
      content: `Hello {{1}} 🏛️\n\nNeed bank loan assistance for {{2}}?\n\nOur representative will contact you shortly to discuss the loan process further.\n\nBest regards,\nThanjai Property Team`,
      isActive: true
    },
    {
      ...
      params: ['{{1}} Client Name', '{{2}} Location / Area', '{{3}} Executive Name', '{{4}} Mobile Number'],
      content: `Vanakkam {{1}} 🙏\n\nTo assist your property search in {{2}}, our local area specialist will assist you:\n👤 Executive: {{3}}\n📞 Mobile: {{4}}\n\nThey will share top verified listings with you right away.\n\nWarm regards,\nThanjai Property Team`,
      isActive: true
    },
    {
      id: 'registration_testimonial_referral',
      name: 'Registration testimonial & review',
      tag: 'registration_testimonial_referral',
      category: 'Stage: Deal Won / Registration',
      params: ['{{1}} Client Name', '{{2}} Property Title', '{{3}} Google Review Link'],
      content: `Hearty Congratulations, {{1}}! 🎉\n\nCongratulations on the successful registration of your {{2}}!\n\nIf you were happy with our service, we would love for you to leave us a quick 5-star Google review.\n⭐ Review Link: {{3}}\n\nWishing you and your family good health, happiness, and prosperity in your new journey!\n\nBest regards,\nThanjai Property Team`,
      isActive: true
    },
    {
      id: 'general_property_update',
      name: 'General property update',
      tag: 'general_property_update',
      category: 'General Property Update',
      params: ['{{1}} Client Name', '{{2}} Property / File Ref', '{{3}} Custom Message Content'],
      content: `Hello {{1}} 👋\n\nUpdate on your property file ({{2}}):\n📌 {{3}}\n\nFeel free to reply if you have any questions!\n\nWarm regards,\nThanjai Property Team`,
      isActive: true
    }
  ];

            ...
            <div class="sticky-enquiry-card">
              ${property.adType === 'paid' ? `
                <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 24px; padding-bottom: 20px; border-bottom: 1px solid var(--color-border);">
                  ...
                  <div>
                    <h4 style="font-size: 1rem; font-weight: 800; color: var(--color-brown);">${property.ownerName || 'Verified Owner'}</h4>
                ...
                <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 24px;">
                  <a href="tel:${property.ownerPhone || '+918489996852'}" class="btn btn-brown" style="width: 100%; display: inline-flex; align-items: center; justify-content: center; gap: 8px;">
                    <i class="ri-phone-fill"></i> CALL OWNER DIRECTLY
                  </a>
                  <a href="https://wa.me/${(property.ownerPhone || '918489996852').replace(/[^0-9]/g, '')}?text=Hi%20${encodeURIComponent(property.ownerName || 'Owner')},%20I%20am%20interested%20in%20your%20property%20${encodeURIComponent(property.title)}%20(ID:%20${property.id})" target="_blank" class="btn btn-primary" style="width: 100%; display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: #25D366; border-color: #25D366;">
